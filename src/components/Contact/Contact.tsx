          ...
          <div className="space-y-8 fade-in-left animation-delay-400 w-full max-w-lg mx-auto lg:mx-0">
            <div className="luxury-card p-10">
              ...
              <p className="premium-text text-lg leading-relaxed mb-10 text-center">
                We are always excited to work on new projects and collaborate with amazing people. 
                Whether you need a complete website, UI/UX design, or technical consultation, 
                We are here to help turn your vision into reality.
              </p>

              {/* Contact Methods */}
              <div className="space-y-4">
                {/* Phone */}
                <div className="flex items-center space-x-4 p-4 bg-slate-50 rounded-none hover:bg-slate-100 transition-colors group">
                  <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow flex-shrink-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a 
                      ...
                      className="premium-text hover:text-slate-900 transition-colors break-words"
                    >
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-slate-50 rounded-none hover:bg-slate-100 transition-colors group">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a 
                        ...
                        className="premium-text hover:text-slate-900 transition-colors break-all"
                      >
                        {personal.email}
                      </a>
                    </div>
                ...
                {/* Location */}
                {personal.location && (
                  <div className="flex items-center space-x-4 p-4 bg-slate-50 rounded-none">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="premium-text break-words">{personal.location}</p>
                    </div>
                  </div>
                )}
                ...
                {personal.socialLinks && personal.socialLinks.length > 0 && (
                  <div className="p-4 bg-slate-50 rounded-none">
                    <h4 className="text-slate-900 font-medium mb-3">Connect With Me</h4>
                    <div className="flex space-x-4">
                      {personal.socialLinks.map((link) => (
                        <a
                          ...
                          className="flex items-center space-x-2 premium-text hover:text-slate-900 transition-colors font-medium border-b border-slate-200 hover:border-slate-900 pb-1"
        ...
        <div className="text-center mt-24 fade-in-up animation-delay-800">
          <div className="luxury-card p-16 max-w-4xl mx-auto">
            ...
            <p className="premium-text text-xl mb-10 max-w-2xl mx-auto">
              Let's schedule a free consultation to discuss your needs and how we can help 
